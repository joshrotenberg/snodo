defmodule Snodo.Protocol do
  ...
  @callback shape_subscription_ack(map(), Snodo.Envelope.id(), Context.t()) :: map()
  @callback shape_subscription_event(SubscriptionEvent.t(), Snodo.Envelope.id(), Context.t()) ::
              map()
  @callback shape_subscription_result(Snodo.Envelope.id(), Context.t()) :: map()
