defmodule Snodo.Prompt do
  ...
  defp literal_options!(env, opts_ast) do
    if Macro.quoted_literal?(opts_ast) do
      ...
      compile_error!(env, "Snodo.Prompt options must be compile-time literals")
    end
  end
  ...
  defp validate_definition!(prompt, _definition) do
    raise ArgumentError,
          "prompt #{inspect(prompt)} definition/0 must return Snodo.Prompt.Definition"
  end
