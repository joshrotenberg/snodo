defmodule Mix.Tasks.Mcp.Example do
  use Mix.Task
  ...
  Runs one repository example in deterministic check mode in a fresh VM.
      ...
      mix mcp.example ../../examples/11_tasks_sqlite.exs
  ...
  def run(_args), do: Mix.raise("usage: mix mcp.example PATH")
end
