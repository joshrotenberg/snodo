defmodule MCP.Extension do
  ...
  inspect `MCP.Context.extensions` to distinguish negotiated requests.
  ...
  @callback transport_policy(MCP.Envelope.t(), Policy.t()) :: Policy.t()
