defmodule MCP.MRTR do
  @moduledoc """
  Validation for the ordinary multi round-trip request boundary.

  Tools, resources, and prompts may return `MCP.Result.input_required/1`.
  A retry invokes the component again with the original component arguments
  and a fresh `MCP.Context`; no process or implicit continuation is retained.
