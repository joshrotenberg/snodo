defmodule MCP.Schema.Validator.Basic.Error do
  @moduledoc "A structured failure returned by `MCP.Schema.Validator.Basic`."
...
defmodule MCP.Schema.Validator.Basic do
  @moduledoc """
  ...
  Validation failures return `MCP.Schema.Validator.Basic.Error` with a JSON
