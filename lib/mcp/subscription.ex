defmodule MCP.Subscription do
  @moduledoc """
  An opened, request-scoped MCP subscription.

  Applications implement `MCP.Subscription.Source`; this module owns filter
  ...
  alias MCP.Subscription.Source
  alias MCP.Subscription.Source.Config
