    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          #
          # Fully qualified names clarify ownership at protocol, DSL-quote, and
          # fixture boundaries; require an alias only when nesting and reuse
          # both make the shorter name materially clearer.
