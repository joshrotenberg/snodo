defmodule Snodo.Extensions.Tasks.Store.Postgres.Migration.V2 do
  @moduledoc """
  ...
  def up(opts \\ []) when is_list(opts) do
    ...
    BEGIN
      ...
      IF NOT FOUND THEN
        RAISE EXCEPTION 'expected snodo Tasks schema version 1';
      END IF;
    END
    $$
    """)
  ...
  def down(opts \\ []) when is_list(opts) do
    ...
    BEGIN
      ...
      IF NOT FOUND THEN
        RAISE EXCEPTION 'expected snodo Tasks schema version #{@schema_version}';
      END IF;
    END
    $$
    """)
