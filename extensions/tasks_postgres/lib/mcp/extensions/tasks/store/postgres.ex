defmodule MCP.Extensions.Tasks.Store.Postgres do
  @moduledoc """
  ...
  effects with `MCP.Extensions.Tasks.Work.idempotency_key`.
  """
  ...
  alias MCP.Extensions.Tasks.Store.Postgres.Lease
  alias MCP.Extensions.Tasks.Store.Postgres.MetadataRow
