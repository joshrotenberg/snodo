defmodule MCP.Extensions.Tasks.Store.Postgres.Migration do
  @moduledoc """
  Current PostgreSQL migration for `MCP.Extensions.Tasks.Store.Postgres`.
  ...
  alias MCP.Extensions.Tasks.Store.Postgres.Migration.V2
