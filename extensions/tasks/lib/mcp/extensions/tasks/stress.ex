defmodule MCP.Extensions.Tasks.Stress do
  @moduledoc """
  ...
  @job_start [:mcp_ex, :tasks, :runner, :job, :start]
  @job_stop [:mcp_ex, :tasks, :runner, :job, :stop]
  @store_transition [:mcp_ex, :tasks, :store, :transition]
